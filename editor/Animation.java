...
public class Animation {
	...
	/*
	 * Sets the room frame. Used in the editor.
	 */
	...
	/*
	 * Set number of frames in this animation. Used in the editor.
	 */
	...
	/*
	 * Set the amount of time between frames in seconds. Used in the editor;
	 */
	...
	/**
	 * Returns the duration from the start of the first frame to the end of the last
	 * frame.
	 */
